smle_nb_prof_ll = function(k, beta_theta, h_N, N, n, Y, beta_cols, Bspline, comp_dat_all,
  ...
  pl_params = smle_nb_profile_out(beta = pert_beta,
                                  theta = pert_theta,
                                  N = N,
                                  n = n,
                                  Y = Y,
  ...
  if(pl_params$converged) {
    od_loglik_pert = smle_nb_od_ll(N = N,
                                   n = n,
                                   Y = Y,
                                   beta_cols = beta_cols,
                                   Bspline = Bspline,
