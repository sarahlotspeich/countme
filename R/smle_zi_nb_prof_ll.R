smle_zi_nb_prof_ll = function(k, beta_theta_eta, h_N, N, n, Y, beta_cols, eta_cols, Bspline, comp_dat_all,
  ...
  pl_params = smle_zi_nb_profile_out(
    beta = pert_beta,
    eta = pert_eta,
    theta = pert_theta,
    N = N,
  ...
  if(pl_params$converged) {
    od_loglik_pert = smle_zi_nb_od_ll(
      N = N,
      n = n,
      Y = Y,
      beta_cols = beta_cols,
